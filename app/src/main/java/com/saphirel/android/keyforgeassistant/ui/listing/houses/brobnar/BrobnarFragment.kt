...
class BrobnarFragment : Fragment() {

    private lateinit var viewModel: BrobnarViewModel
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        tabs.tabGravity = TabLayout.GRAVITY_FILL

        val adapter = CardsPager(fragmentManager!!, JSonManager.loadHouseCardsFromJSon("brobnar", resources, context!!)!!)
    ...
    override fun onCreateView(
        ...
        viewModel =
            ViewModelProviders.of(this).get(BrobnarViewModel::class.java)
